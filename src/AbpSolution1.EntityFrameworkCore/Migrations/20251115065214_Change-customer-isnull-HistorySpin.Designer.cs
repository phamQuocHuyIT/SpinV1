...
namespace AbpSolution1.Migrations
{
    ...
    [Migration("20251115065214_Change-customer-isnull-HistorySpin")]
    partial class ChangecustomerisnullHistorySpin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpSolution1.Administration.Customer.Customers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AbpSolution1.Config.Product.Products", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Spin_Products");
                });

            modelBuilder.Entity("AbpSolution1.Config.Spins.HistorySpin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HistorySpins");
                });

            modelBuilder.Entity("AbpSolution1.Config.Spins.Spin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Spin_Spins");
                });

            modelBuilder.Entity("AbpSolution1.Config.Spins.SpinCustomer", b =>
                {
                    b.Property<int>("SpinId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SpinId", "CustomerId");

                    b.HasIndex("CustomerId");

                    b.ToTable("SpinCustomers");
                });

            modelBuilder.Entity("AbpSolution1.Config.Spins.SpinProduct", b =>
                {
                    b.Property<int>("SpinId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SpinId", "ProductId");

                    b.HasIndex("ProductId");

                    b.ToTable("SpinProducts");
                });
            ...
            modelBuilder.Entity("AbpSolution1.Config.Spins.SpinCustomer", b =>
                {
                    b.HasOne("AbpSolution1.Administration.Customer.Customers", "Customer")
                        .WithMany("SpinCustomers")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AbpSolution1.Config.Spins.Spin", "Spin")
                        .WithMany("SpinCustomers")
            ...
            modelBuilder.Entity("AbpSolution1.Config.Spins.SpinProduct", b =>
                {
                    b.HasOne("AbpSolution1.Config.Product.Products", "Product")
                        .WithMany("SpinProducts")
